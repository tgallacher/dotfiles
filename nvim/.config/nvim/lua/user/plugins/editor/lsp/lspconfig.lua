  ...
  -- LSP config
  {
    ...
    config = function()
      ...
      local on_attach = function(client, bufnr)
        ...
        -- stylua: ignore
        -- keymap({ "n", "v" }, "<leader>fm", function() vim.lsp.buf.format { async = true } end, opts)
        keymap({ "n", "v" }, "<localleader>ca", "<cmd>Lspsaga code_action<cr>", opts)
        keymap("n", "<localleader>ls", function() require("telescope.builtin").lsp_document_symbols() end, opts)                                                                                                  -- document symbols
        -- stylua: ignore
        keymap("n", "<localleader>ls", function() require("telescope.builtin").lsp_dynamic_workspace_symbols() end, opts) -- workspace symbols
