  ...
  { -- Note: To see this don't use `nvim .` in a dir. Instead just use `nvim`.
    ...
    opts = function()
      ...
      local function getGreeting()
        ...
        if hour == 23 or hour < 7 then greetingIndex = 1
        elseif hour < 12 then greetingIndex = 2
        elseif hour >= 12 and hour < 18 then greetingIndex = 3
        elseif hour >= 18 and hour < 21 then greetingIndex = 4
        elseif hour >= 21 then greetingIndex = 5
        end
