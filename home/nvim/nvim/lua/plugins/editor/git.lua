return {
  { -- highlight+give keymaps for git merge conflict marker sections
    ...
    init = function()
      ...
      vim.api.nvim_set_hl(0, "ConflictMarkerBegin", { fg = colors.git.change, bg = colors.bg })
      vim.api.nvim_set_hl(0, "ConflictMarkerOurs", { fg = colors.git.delete, bg = colors.bg })
      ...
      vim.api.nvim_set_hl(0, "ConflictMarkerTheirs", { fg = colors.git.add, bg = colors.bg })
      vim.api.nvim_set_hl(0, "ConflictMarkerEnd", { fg = colors.git.change, bg = colors.bg })
    end,
  },
