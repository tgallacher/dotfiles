{
  ...
  nvimConfigLocation = "${config.home.homeDirectory}/Code/tgallacher/dotfiles/home/tmux";
in {
  home.file.".config/tmux/".source = config.lib.file.mkOutOfStoreSymlink nvimConfigLocation;
